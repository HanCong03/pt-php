...
<link rel="stylesheet" href="<?php echo e(asset('assets/pages/dev/failure/page.css')); ?>">
<script src="<?php echo e(asset('assets/pages/dev/failure/page.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content-box'); ?>
<h2>很抱歉，您的审核 <span>未通过</span>！请重新提交审核材料</h2>
    ...
    <div class="org-box info-box">
        ...
        <table>
            ...
            <tr>
                <th>组织全称</th>
                <td>
                    <input type="text" placeholder="请填写与营业执照一致的名称" value="北京金桐网投资有限公司" name="full-name">
                </td>
            </tr>
            ...
            <tr>
                <th>组织简称</th>
                <td>
                    <input type="text" placeholder="请填写不超过6个字的组织简称" value="金桐网" name="short-name">
                </td>
            </tr>
            ...
            <tr>
                <th>行业</th>
                <td>
                    <input type="text" placeholder="请选择组织行业" value="房地产" class="industry-input" name="industry">
                </td>
            </tr>
        ...
        <table>
            ...
            <tr>
                <th>联系人</th>
                <td>
                    <input type="text" placeholder="请填写联系人的真实姓名" value="张三" name="contacts-name">
                </td>
            </tr>
            ...
            <tr>
                <th>手机号码</th>
                <td>
                    <input type="text" placeholder="请填写联系人的手机号码" value="13162657788" name="contacts-name">
                </td>
            </tr>
            ...
            <tr>
                <th>电子邮箱</th>
                <td>
                    <input type="text" placeholder="请填写联系人的电子邮箱" value="zhangsan@gintong.com" name="contacts-email">
                </td>
            </tr>
            </tbody>
        </table>
    ...
    <div class="personal-box info-box">
        ...
        <table>
            ...
            <tr>
                <th>真实姓名</th>
                <td>
                    <input type="text" placeholder="请填写与身份证一致的姓名" value="张三" name="name">
                </td>
            </tr>
            ...
            <tr>
                <th>手机号码</th>
                <td>
                    <input type="text" placeholder="请填写您的手机号码" value="13162657788" name="phone">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <select x-select x-class="type-select" class="type">
                        <option>请选择分类</option>
                        <option selected="selected">金融机构</option>
                        <option>一般企业</option>
                        <option>政府组织</option>
                        <option>中介机构</option>
                        <option>专业媒体</option>
        ...
        <tr>
            <th colspan="2">
                <label>
                    ...
                    我同意并遵守上述的<a class="hint-link" target="_blank" href="<?php echo e(route('service-agreement')); ?>">《星云开放平台开发者服务协议》</a>
                </label>
            </th>
        </tr>
        </tbody>
