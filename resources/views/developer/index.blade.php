...
<link rel="stylesheet" href="{{asset('assets/base/styles/cropper.min.css')}}">
<link rel="stylesheet" href="{{asset('assets/base/date-picker/jquery.datetimepicker.css')}}">
<link rel="stylesheet" href="{{asset('assets/base/date-picker/date-picker.css')}}">

<script src="{{asset('assets/base/scripts/cropper.min.js')}}"></script>
<script src="{{asset('assets/base/date-picker/jquery.datetimepicker.full.min.js')}}"></script>
<script src="{{asset('assets/base/date-picker/date-picker.js')}}"></script>
@stop

@section('page-assets')
<link rel="stylesheet" href="{{asset('assets/pages/dev/basic/page.css')}}">
<script src="{{asset('assets/pages/dev/basic/page.js')}}"></script>
@stop
...
<div class="inner-content-box">
    <div class="right-box">
        <div class="right-head-box not-set">
            <img src="{{asset('assets/default-user-head.jpg')}}" width="80px" height="80px">
            <a href="{{route('avatar')}}" class="hint-link">添加头像</a>
        </div>

        <div class="right-head-box setted">
            <img src="{{asset('assets/user-head.png')}}" width="80px" height="80px">
            <a href="{{route('avatar')}}" class="hint-link">修改头像</a>
        </div>
    </div>
